<?php
    if(isset($_POST['ment'])){
       ...
       if (mysqli_num_rows($same_email_resoult) > 0) {
        ...
        if ($pwd==$pwd2) { print "<h1>Sikeresen módosítva.</h1>";
                    ...
                    <div class="my-5">
                        ...
                        method="POST"> <!--data-sb-form-api-token="API_TOKEN"-->
                            ...
                            <div class="form-floating">
                                ...
                                name="pwd" value=<?php print $row['password']; ?>
                            ...
                            <div class="form-floating">
                                ...
                                name="pwd2" value=<?php print $row['password']; ?>
                                type="password" placeholder="password" 
                                data-sb-validations="required" />
                            ...
                            <select class="form-control" id="jog" name="jog">
                                ...
                                while($row2=mysqli_fetch_assoc($result)){
                                    ?>
                                    <option value=<?php print $row2['id'];?> <?php if($row['jog'] == $row2['id']) print 'selected';?>><?php print $row2['megnevezes'];?></option>
                                <?php
                                }
                                ?>
                            </select>
                            ...
                            type="submit" name="ment" value="Mentés">
