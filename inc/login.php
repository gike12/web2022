            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="my-5">
                            <form id="contactForm" action="index.php?oldal=login"
							method="POST">
								...
								<div class="text-center text-danger mb-3">Error sending message!</div></div><br>
								<input class="btn btn-primary text-uppercase" 
								type="submit" name="login" value="Bejelentkezés">
